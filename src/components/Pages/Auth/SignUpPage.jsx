          ...
          <form className="flex flex-col gap-5" onSubmit={(e) => { e.preventDefault(); onNavigate('verify-email'); }}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex w-full items-stretch rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                ...
                <input required className="flex-1 bg-transparent border-none focus:ring-0 py-3.5 px-3 text-slate-900 dark:text-slate-100 placeholder:text-slate-400" placeholder="Create a password" type="password"/>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex w-full items-stretch rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                ...
                <input required className="flex-1 bg-transparent border-none focus:ring-0 py-3.5 px-3 text-slate-900 dark:text-slate-100 placeholder:text-slate-400" placeholder="Repeat your password" type="password"/>
              </div>
            </div>
            ...
            <button 
              className="w-full bg-primary hover:bg-yellow-400 text-slate-900 font-bold py-4 px-6 rounded-xl shadow-lg shadow-primary/20 transform transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-4" 
              type="submit"
            >
