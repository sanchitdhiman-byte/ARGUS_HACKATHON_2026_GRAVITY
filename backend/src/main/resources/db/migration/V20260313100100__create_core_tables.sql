...
CREATE TABLE programme_form_fields (
    id              UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE TABLE programme_required_documents (
    id              UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    programme_id    UUID NOT NULL REFERENCES grant_programmes(id) ON DELETE CASCADE,
...
CREATE TABLE programme_eligibility_criteria (
    id              UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    programme_id    UUID NOT NULL REFERENCES grant_programmes(id) ON DELETE CASCADE,
...
CREATE TABLE programme_scoring_rubric (
    id              UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    programme_id    UUID NOT NULL REFERENCES grant_programmes(id) ON DELETE CASCADE,
...
CREATE TABLE programme_workflow_stages (
    id              UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    programme_id    UUID NOT NULL REFERENCES grant_programmes(id) ON DELETE CASCADE,
